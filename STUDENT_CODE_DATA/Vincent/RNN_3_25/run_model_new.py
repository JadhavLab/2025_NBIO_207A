...
sys.path.append('/home/vincent/Senior thesis work/underlying functions')  
sys.path.append('/home/vincent/Senior thesis work/underlying functions/ephys_data')
sys.path.append('/home/vincent/Senior thesis work/blechRNN-master/src') 
from model import autoencoderRNN
from train import train_model

plot_dir = '/home/vincent/Senior thesis work/blechRNN-master/output/plots_new'
from ephys_data import ephys_data
import visualize as vz

#base_dir =  '/home/vincent/Senior thesis work/blechRNN-master/pytorch_rnn'
#plot_dir = os.path.join(plot_dir, 'plots')
if not os.path.exists(plot_dir):
    os.makedirs(plot_dir)

artifacts_dir = '/home/vincent/Senior thesis work/blechRNN-master/output_new/artifacts_new'
#artifacts_dir = os.path.join(base_dir, 'artifacts')
if not os.path.exists(artifacts_dir):
    os.makedirs(artifacts_dir)

data_dir = '/home/vincent/Senior thesis work/blechRNN-master/data/AM11_4Tastes_191031_083633' 
